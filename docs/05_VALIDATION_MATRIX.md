...
| M5PM1 power (full) | Partial | `evidence/20260601-hw010-p3-battery-boot.log` | Via the MFD: GPIO child (L3B/PYG2 rail + PYG3 audio-amp gate) and ADC child (VBAT, HW-010) done; charger/fuel-gauge rails still roadmap |

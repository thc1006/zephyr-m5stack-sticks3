...
- [x] **Unit tests** — `tests/drivers/audio/es8311` → twister native_sim **72/72** (was 11,
  then 29, 33, 42, 47, 51, 52, 54, 59, 60, 61, 62, 65, 67, 68, 69). Coverage is ~97% of lines and ~76% of branches (`gcovr`); every
